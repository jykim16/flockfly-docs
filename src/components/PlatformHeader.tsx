...
export function PlatformHeader({ workspaceLabel = 'Preview workspace' }: { workspaceLabel?: string }) {
  return <header className="platform-header" aria-label="Flockfly platform navigation">
    ...
    <div className="user-chip"><i aria-hidden="true" /><span>{workspaceLabel}</span></div>
  </header>;
}
