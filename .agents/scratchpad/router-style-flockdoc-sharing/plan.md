...
- [x] RED: contracts expose Router-shaped Flockdoc members/invitations and only the three assignable document roles.
- [x] RED: invitations do not grant access until accepted; accept/decline/cancel and member role/removal are covered.
- [x] RED: private/public visibility and public membership join are covered.
